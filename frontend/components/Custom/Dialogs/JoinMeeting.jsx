      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <div className="grid gap-4 py-4">
          <div className="flex flex-col items-center gap-4">
            <Input id="name" className="col-span-3 max-h-[50px] sm:h-[40px]" placeholder="29989829732" />
          </div>
          <div className="flex flex-col items-center gap-4">
            <Input id="username" className="col-span-3 max-h-[50px] sm:h-[40px]" placeholder="Joseph A."/>
          </div>
        </div>
        <DialogFooter>
          <Button type="submit" variant="disabled">Join</Button>
          <DialogClose>
